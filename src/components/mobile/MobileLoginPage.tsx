...
const MobileLoginPage: React.FC<MobileLoginPageProps> = ({ fileName, onBack, onLoginSuccess }) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (sessionResponse.ok) {
        ...
        // Show mobile-optimized success message with dark theme
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-10 left-5 w-24 h-24 bg-[#8B5CF6]/8 rounded-full blur-xl"></div>
      <div className="absolute bottom-10 right-5 w-32 h-32 bg-[#FF0000]/6 rounded-full blur-2xl"></div>
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-[#EC4899]/10 rounded-full blur-lg"></div>
      <div className="absolute bottom-1/4 right-1/3 w-20 h-20 bg-[#8B5CF6]/7 rounded-full blur-lg"></div>
      ...
      <div className="relative z-10 min-h-screen p-5">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8 pt-8">
            <button
              onClick={onBack}
              className="inline-flex items-center gap-3 text-gray-300 hover:text-white mb-8 transition-colors duration-200 p-3 bg-[#2C2C2C]/25 backdrop-blur-sm rounded-xl shadow-sm"
            >
              <ArrowLeft className="w-5 h-5" />
              <span className="text-base font-semibold">Back to Files</span>
            </button>
            
            <div className="w-20 h-20 flex items-center justify-center mx-auto mb-6 bg-[#1E1E1E]/95 backdrop-blur-sm rounded-2xl shadow-lg border border-[#2C2C2C]/50">
              <img 
            ...
            <h1 className="text-2xl font-bold text-white mb-3">Access Protected File</h1>
            <p className="text-base text-white font-bold leading-relaxed px-4 bg-[#2C2C2C]/25 backdrop-blur-sm rounded-xl py-3 mx-2 shadow-sm">
              Please authenticate to access <span className="font-bold break-all text-[#FF0000]">{fileName}</span>
            </p>
          </div>

          {/* Login Form */}
          <div className="bg-[#1E1E1E]/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-[#2C2C2C]/70 p-6">
            {!selectedProvider ? (
              // Provider Selection
              <div>
              ...
              <div>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-4 border-2 border-[#2C2C2C] rounded-2xl focus:ring-2 focus:ring-[#FF0000] focus:border-transparent transition-all duration-200 bg-[#2C2C2C]/80 text-base font-semibold text-white placeholder-gray-400"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-14 py-4 border-2 border-[#2C2C2C] rounded-2xl focus:ring-2 focus:ring-[#FF0000] focus:border-transparent transition-all duration-200 bg-[#2C2C2C]/80 text-base font-semibold text-white placeholder-gray-400"
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-300 transition-colors duration-200 p-1"
                      >
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-[#FF0000] to-[#DC2626] text-white py-4 rounded-2xl font-semibold text-lg hover:from-[#DC2626] hover:to-[#B91C1C] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform active:scale-95 shadow-lg mt-6"
                  >
                    {isLoading ? (
          ...
          <div className="text-center mt-8 pb-8">
            <p className="text-sm text-gray-400 font-bold bg-[#2C2C2C]/25 backdrop-blur-sm rounded-xl py-3 px-4 inline-block shadow-sm">
