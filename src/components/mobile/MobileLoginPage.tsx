...
-      {/* Adobe-style linear gradient background with increased brightness */}
-      <div className="absolute inset-0 bg-gradient-to-br from-[#FF6B6B] to-[#FFE5E5]"></div>
...
-      {/* Mobile-optimized complementary decorative elements with better visibility */}
-      <div className="absolute top-10 left-5 w-24 h-24 bg-[#FFE5E5]/15 rounded-full blur-xl"></div>
-      <div className="absolute bottom-10 right-5 w-32 h-32 bg-white/12 rounded-full blur-2xl"></div>
-      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-white/15 rounded-full blur-lg"></div>
-      <div className="absolute bottom-1/4 right-1/3 w-20 h-20 bg-[#FF6B6B]/12 rounded-full blur-lg"></div>
       ...
       <div className="relative z-10 min-h-screen p-5">
         <div className="max-w-md mx-auto">
           ...
           <div className="text-center mb-8 pt-8">
             <button
               onClick={onBack}
-              className="inline-flex items-center gap-3 text-gray-800 hover:text-gray-900 mb-8 transition-colors duration-200 p-2 bg-white/20 backdrop-blur-sm rounded-xl"
...
-            <div className="w-20 h-20 flex items-center justify-center mx-auto mb-6 bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg">
...
-            <p className="text-base text-gray-900 font-semibold leading-relaxed px-4 bg-white/20 backdrop-blur-sm rounded-xl py-2 mx-2">
