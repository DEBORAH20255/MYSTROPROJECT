  ...
  const renderMobileFileList = () => (
    <div className="space-y-4">
      {currentFiles.map((file, index) => (
        <div
          key={index}
          className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-lg border border-white/50 overflow-hidden"
        >
          {/* File Header */}
          <div className="p-5">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl font-medium text-base hover:from-red-700 hover:to-red-800 transition-all duration-200 shadow-lg active:scale-95"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-4 bg-white/90 backdrop-blur-sm border-2 border-gray-200 text-gray-700 rounded-xl font-medium text-base hover:bg-white hover:border-gray-300 transition-all duration-200 shadow-md active:scale-95"
              >
